...
- [Scripts](#scripts)
  - [setup.py](#setuppy)
  - [exfiltrateFile(s).ps1](#exfiltratefilesps1)
  - [infoGather.ps1](#infogatherps1)
  - [launchVoice.ps1](#launchvoiceps1)
  - [mapFiles.ps1](#mapfilespse1)
  - [openWebPageFull.ps1](#openwebpagefullps1)
  - [qrCode.ps1](#qrcodeps1)
  - [ransom.ps1](#ransomps1)
  - [rickRoll.ps1](#rickrollps1)
  - [rickRollMac.sh](#rickrollmacsh)
  - [selfDestruct.ps1](#selfdestructps1)
